...
$lang['Explain']['restore']         = "This module will allow you to restore the script's tables previously backed up by Wanewsletter.\nOnly use SQL files generated by Wanewsletter! (the parser est very simple) \nIf file upload is not authorized on your server, you can specify a file previously uploaded with ftp by indicating its path (relative to the script's root)";
