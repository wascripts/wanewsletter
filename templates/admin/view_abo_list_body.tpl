...
<div class="bloc">
	<table class="content">
		<tr>
			...
			<td class="row2"> <input type="text" id="keyword" name="keyword" value="{KEYWORD}" size="35" maxlength="60" class="text" /> <input type="submit" name="search" value="{L_SEARCH_BUTTON}" class="pbutton" /> </td>
		</tr>
		<tr>
...
<div class="bloc">
	<table class="content">
		<tr>
			<td rowspan="2" class="row1"> <label for="email_list">{delete_option.L_FAST_DELETION}&#160;: </label><br /><span class="m-texte">{delete_option.L_FAST_DELETION_NOTE}</span> </td>
...
<div id="nav-top">
	...
	<div class="right"> {S_HIDDEN_FIELDS}
		<p>{L_CLASSEMENT}&#160;: </p> <select name="type"><option value="abo_email"{SELECTED_TYPE_EMAIL}> - {L_BY_EMAIL} - </option><option value="abo_register_date"{SELECTED_TYPE_DATE}> - {L_BY_DATE} - </option><option value="format"{SELECTED_TYPE_FORMAT}> - {L_BY_FORMAT} - </option></select>&nbsp;&nbsp;<select name="order"><option value="ASC"{SELECTED_ORDER_ASC}> - {L_BY_ASC} - </option><option value="DESC"{SELECTED_ORDER_DESC}> - {L_BY_DESC} - </option></select>&#160;&#160;<input type="submit" name="tri" value="{L_CLASSER_BUTTON}" class="button" />
	</div>
</div>
...
<div class="bloc">
	...
	<table class="content">
		...
		<tr>
			...
			<!-- END format -->
			<!-- BEGIN delete -->
			<td class="{aborow.TD_CLASS}"> <input type="checkbox" name="abo_id[]" value="{aborow.delete.ABO_ID}" /> </td>
			<!-- END delete -->
		</tr>
		<!-- END aborow -->
		<!-- BEGIN empty -->
