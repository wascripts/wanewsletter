...
<div class="bloc">
	...
	<table class="content">
		...
		<tr>
			...
			<td class="row2"> <input type="radio" id="confirm_subscribe_yes" name="confirm_subscribe" value="1"{CHECK_CONFIRM_YES} /> <label for="confirm_subscribe_yes" class="m-texte">{L_YES}</label> &#160; <input type="radio" id="confirm_subscribe_no" name="confirm_subscribe" value="0"{CHECK_CONFIRM_NO} /> <label for="confirm_subscribe_no" class="m-texte">{L_NO}</label> </td>
		</tr>
		<tr>
	...
	<table class="content">
		...
		<tr>
			...
			<td class="row2"> <input type="radio" id="auto_purge_on" name="auto_purge" value="1"{CHECKED_PURGE_ON} /> <label for="auto_purge_on" class="m-texte">{L_YES}</label> &#160; <input type="radio" id="auto_purge_off" name="auto_purge" value="0"{CHECKED_PURGE_OFF} /> <label for="auto_purge_off" class="m-texte">{L_NO}</label> </td>
		</tr>
		<tr>
	...
	<table class="content">
		...
		<tr>
			...
			<td class="row2"> <input type="radio" id="use_cron_on" name="use_cron" value="1"{CHECKED_USE_CRON_ON}{DISABLED_CRON} /> <label for="use_cron_on" class="m-texte">{L_YES}</label> &nbsp; <input type="radio" id="use_cron_off" name="use_cron" value="0"{CHECKED_USE_CRON_OFF} /> <label for="use_cron_off" class="m-texte">{L_NO}</label> </td>
		</tr>
		<tr>
	...
	<div class="bottom"> {S_HIDDEN_FIELDS}
		<input type="submit" name="submit" class="pbutton" value="{L_VALID_BUTTON}" /> <input type="submit" name="cancel" class="button" value="{L_CANCEL_BUTTON}" />
	</div>
</div>
</form>
