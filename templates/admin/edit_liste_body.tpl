...
<div class="bloc">
	...
	<table class="content">
		...
		<tr>
			...
			<td class="row2"><input type="text" id="limitevalidate" name="limitevalidate" value="{LIMITEVALIDATE}" size="5" maxlength="3" class="text number" /> <span class="m-texte">{L_DAYS}</span></td>
		</tr>
		<tr>
	...
	<table class="content">
		...
		<tr>
			...
			<td class="row2"><input type="text" id="purge_freq" name="purge_freq" value="{PURGE_FREQ}" size="5" maxlength="3" class="text number" /> <span class="m-texte">{L_DAYS}</span></td>
		</tr>
	</table>
	...
	<table class="content">
		...
		<tr>
			...
			<td class="row2"><input type="text" id="pop_port" name="pop_port" maxlength="5" value="{POP_PORT}" class="text number"{DISABLED_CRON} /></td>
		</tr>
		<tr>
