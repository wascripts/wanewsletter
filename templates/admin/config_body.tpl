...
<div class="bloc">
	...
	<table class="content">
		...
		<tr>
			...
			<td class="row2"> <input type="radio" id="enable_profil_cp_yes" name="enable_profil_cp" value="1" {CHECKED_PROFIL_CP_ON}/> <label for="enable_profil_cp_yes" class="m-texte">{L_YES}</label> &#160; <input type="radio" id="enable_profil_cp_no" name="enable_profil_cp" value="0" {CHECKED_PROFIL_CP_OFF}/> <label for="enable_profil_cp_no" class="m-texte">{L_NO}</label> </td>
		</tr>
	</table>
	...
	<table class="content">
		...
		<tr>
			...
			<td class="row2"> <input type="radio" id="use_ftp_yes" name="use_ftp" value="1" {extension_ftp.CHECKED_USE_FTP_ON}/> <label for="use_ftp_yes" class="m-texte">{L_YES}</label> &#160; <input type="radio" id="use_ftp_no" name="use_ftp" value="0" {extension_ftp.CHECKED_USE_FTP_OFF}/> <label for="use_ftp_no" class="m-texte">{L_NO}</label> </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="row2"> <input type="radio" id="ftp_pasv_on" name="ftp_pasv" value="1" {extension_ftp.CHECKED_FTP_PASV_ON}/> <label for="ftp_pasv_on" class="m-texte">{L_YES}</label> &#160; <input type="radio" id="ftp_pasv_off" name="ftp_pasv" value="0" {extension_ftp.CHECKED_FTP_PASV_OFF}/> <label for="ftp_pasv_off" class="m-texte">{L_NO}</label> </td>
		</tr>
		<tr>
	...
	<table class="content">
		...
		<tr style="display: none;">
			...
			<td class="row2"> <input type="radio" id="check_email_mx_on" name="check_email_mx" value="1"{CHECKED_CHECK_EMAIL_ON} /> <label for="check_email_mx_on" class="m-texte">{L_YES}</label> &#160; <input type="radio" id="check_email_mx_off" name="check_email_mx" value="0"{CHECKED_CHECK_EMAIL_OFF} /> <label for="check_email_mx_off" class="m-texte">{L_NO}</label> </td>
		</tr>
		<tr>
			<td class="row1"> <label>{L_ENGINE_SEND}&#160;:</label> </td>
			<td class="row2"> <input type="radio" id="engine_send_bcc" name="engine_send" value="1"{CHECKED_ENGINE_BCC} /> <label for="engine_send_bcc" class="m-texte">{L_ENGINE_BCC}</label> <br /> <input type="radio" id="engine_send_uniq" name="engine_send" value="2"{CHECKED_ENGINE_UNIQ} /> <label for="engine_send_uniq" class="m-texte">{L_ENGINE_UNIQ}</label> </td>
		</tr>
		<tr>
	...
	<table class="content">
		...
		<tr>
			...
			<td class="row2"> <input type="radio" id="disable_stats_off" name="disable_stats" value="0" {extension_gd.CHECKED_DISABLE_STATS_OFF}/> <label for="disable_stats_off" class="m-texte">{L_NO}</label> &#160; <input type="radio" id="disable_stats_on" name="disable_stats" value="1" {extension_gd.CHECKED_DISABLE_STATS_ON}/> <label for="disable_stats_on" class="m-texte">{L_YES}</label> </td>
		</tr>
		<tr>
			<td class="row1"> <label for="gd_img_type">{extension_gd.L_GD_VERSION}&#160;:</label> </td>
			<td class="row2"> <select id="gd_img_type" name="gd_img_type"><option value="png"{extension_gd.SELECTED_GD_PNG}> - Lib gd &gt;= 1.6 - </option><option value="gif"{extension_gd.SELECTED_GD_GIF}> - Lib gd &lt; 1.6 - </option></select> </td>
		</tr>
	</table>
	<!-- END extension_gd -->
