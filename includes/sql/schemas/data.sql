...
INSERT INTO wa_admin (admin_login, admin_pwd, admin_email, admin_lang, admin_dateformat, admin_level)
	VALUES('admin', '$2y$10$5IAy.2zYfrQ9YxUmcZWW4ubOnGwO9RdE1ci/rtkkxehOY/ehS0ylm', 'admin@domaine.com', 'francais', 'd M Y H:i', 2);
...
INSERT INTO wa_config (config_name, config_value) VALUES('db_version',     '20');
